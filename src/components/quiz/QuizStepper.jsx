  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 1:
        return (
          <div>
            <h3 className="text-info mb-2 text-2xl pb-10">I want to take a quiz on :</h3>
            <select
              className="form-select"
              value={selectedSubject}
              onChange={handleSubjectChange}
      ...
      case 2:
        return (
          <div>
            <h4 className="text-info mb-2 text-2xl pb-10">
              How many questions would you like to attempt ?
            </h4>
            <input
              type="number"
      ...
      case 3:
        return (
          <div>
            <h2>Confirmation</h2>
            <p>Subject: {selectedSubject}</p>
            <p className="pb-10">Number of Questions: {selectedNumQuestions}</p>
          </div>
        );
      default:
        return null;
    ...
    <div>
      ...
      <section className="mt-5">
        ...
        <div className="card p-20">
          <div className="card-body">
            {subjects.length > 0 && renderStepContent()}
            <div className="d-flex justify-content-between mt-4">
              {currentStep > 1 && (
                <button className="btn btn-primary" onClick={handlePrevious}>
                  Previous
